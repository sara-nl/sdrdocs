...
- **Files size**
	Currently the maximum data size is 4 GB per file and 10 GB for a deposit. The maximum number of files that can be uploaded via the onlone deposite is 100 files.
